...
TOOL_SCHEMAS = [
 ...
 {"type":"function","function":{"name":"semantic_search","description":"Perform semantic/fuzzy search across workspace code and text files.","parameters":{"type":"object","properties":{"query":{"type":"string"},"path":{"type":"string"},"top_k":{"type":"integer","minimum":1,"maximum":50}},"required":["query"],"additionalProperties":False}}},
...
class ToolRegistry:
    def __init__(self, settings: Settings) -> None:
        ...
        self._handlers: dict[str, Callable[..., dict[str, Any]]] = {
            ...
            "write_file": self.files.write_file, "create_file": self.files.create_file, "delete_file": self.files.delete_file,
